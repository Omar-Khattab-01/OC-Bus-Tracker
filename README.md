...
### Optional live bus → paddle refresh features

- `SUPABASE_SERVICE_ROLE_KEY`
- `CRON_SECRET`
- `LIVE_BUS_MAPPING_TTL_MS`
- `CRON_FETCH_CONCURRENCY`
...
If your project was already set up earlier, use the migrations you need instead:

- [supabase/migration_saved_work_lists.sql](supabase/migration_saved_work_lists.sql)
- [supabase/migration_live_bus_paddles.sql](supabase/migration_live_bus_paddles.sql)
